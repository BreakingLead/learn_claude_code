...
默认地址是 `http://127.0.0.1:8787`，可以用 `BEE_AGENT_NODE_EDITOR_ADDR=:8787` 修改。
...
```bash
BEE_AGENT_USE_BLUEPRINT=1 BEE_AGENT_BLUEPRINT_ID=time-aware-agent go run ./cmd/bee-agent
```
